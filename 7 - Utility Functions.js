...
// Used by both daily ingestion (8 - Data Ingestion.js) and historical ingestion (tmp/db-script.js)
// ============================================================================
 ...
 * Uses the same validation as db-script.js: validates will_pay_2 and will_pay_1_p3
...
function hasValidEntryData(valueRow, displayRow, columnMap = null) {
    try {
        // Default column indices if columnMap not provided (matches db-script.js structure)
