...
// Used by ROI processing (05-ROIProcessing.js) and external daily ingestion
// ============================================================================
 ...
 * Validates will_pay_2 and will_pay_1_p3 (required fields for entry validation)
...
function hasValidEntryData(valueRow, displayRow, columnMap = null) {
    try {
        // Default column indices if columnMap not provided
